<?php get_header(); ?>
    ...
    <div class="tn-site-content">
        <div class="tn-content-area">
            <main class="tn-site-main tn-archive-main tn-author-main">
                <!-- Content: Author Header -->
                <?php get_template_part( 'parts/content', 'author-header' ); ?>

                <!-- Content: Blog Posts Archive & Sidebars -->
                <section id="blog-posts" class="tn-section tn-blog tn-archive-blog tn-author-blog">
